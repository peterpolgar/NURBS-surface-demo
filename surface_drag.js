...
var scp_arr, cam, zunit, FELB, puff_arr, sugar, szog1, szog2, drawcn, drawcp, drawkp, notPopup, dmx, dmy, shift_x, shift_y, shift_z;
...
function draw() {
    ...
    if( !drawed ){
        ...
        pointLight(0, 230, 0, 0, 0, 3 * zunit);
        // lights();
...
function mouseDragged() {
    if ( mouseX <= mousexmax && mouseY > mouseymin ) {
        if ( mouseButton === LEFT ) {
            var deltax = mouseX - dmx, deltay = mouseY - dmy;
